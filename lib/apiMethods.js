module.exports = {
  ...
  "users_deactivate_bankaccount" : [ "/${apiVersion}/${clientId}/users/${userId}/bankaccounts/${bankAccountId}", "PUT" ],
  ...
  "reports_create" : ["/${apiVersion}/${clientId}/reports/transactions/", "POST"],
