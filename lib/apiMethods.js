module.exports = {
    ...
    "transactions_get_by_fingerprint": ["/${apiVersion}/${clientId}/cards/fingerprints/${fingerprint}/transactions", "GET"],
    ...
    "payins_paypal_data_collection_create": ["/${apiVersion}/${clientId}/payins/payment-methods/paypal/data-collection", "POST"],
    "payins_paypal_data_collection_get": ["/${apiVersion}/${clientId}/payins/payment-methods/paypal/data-collection/${id}", "GET"],
    ...
    "payins_bizum-web_create": ["/${apiVersion}/${clientId}/payins/payment-methods/bizum", "POST"],
    "payins_swish-web_create": ["/${apiVersion}/${clientId}/payins/payment-methods/swish", "POST"],
    ...
    "payins_intent_cancel": ["/V3.0/${clientId}/payins/intents/${intentId}/cancel", "POST"],
    "payins_intent_create_splits": ["/V3.0/${clientId}/payins/intents/${intentId}/splits", "POST"],
    "payins_intent_execute_split": ["/V3.0/${clientId}/payins/intents/${intentId}/splits/${splitId}/execute", "POST"],
    ...
    "users_createnaturals_sca": ["/${apiVersion}/${clientId}/sca/users/natural", "POST"],
    "users_createlegals": ["/${apiVersion}/${clientId}/users/legal", "POST"],
    "users_createlegals_sca": ["/${apiVersion}/${clientId}/sca/users/legal", "POST"],
    ...
    "users_get_sca": ["/${apiVersion}/${clientId}/sca/users/${id}", "GET"],
    "users_getnaturals": ["/${apiVersion}/${clientId}/users/natural/${id}", "GET"],
    "users_getlegals": ["/${apiVersion}/${clientId}/users/legal/${id}", "GET"],
    "users_getnaturals_sca": ["/${apiVersion}/${clientId}/sca/users/natural/${id}", "GET"],
    "users_getlegals_sca": ["/${apiVersion}/${clientId}/sca/users/legal/${id}", "GET"],
    ...
    "users_savenaturals_sca": ["/${apiVersion}/${clientId}/sca/users/natural/${id}", "PUT"],
    "users_savelegals": ["/${apiVersion}/${clientId}/users/legal/${id}", "PUT"],
    "users_savelegals_sca": ["/${apiVersion}/${clientId}/sca/users/legal/${id}", "PUT"],
    "users_categorizenaturals_sca": ["/${apiVersion}/${clientId}/sca/users/natural/${id}/category", "PUT"],
    "users_categorizelegals_sca": ["/${apiVersion}/${clientId}/sca/users/legal/${id}/category", "PUT"],
    "users_enroll_sca": ["/${apiVersion}/${clientId}/sca/users/${id}/enrollment", "POST"],
    ...
    "disputes_get_for_payin": ["/${apiVersion}/${clientId}/payins/${id}/disputes", "GET"],
    ...
    "reports_create": ["/${apiVersion}/${clientId}/reporting/reports/", "POST"],
    "reports_get_v2": ["/${apiVersion}/${clientId}/reporting/reports/${id}", "GET"],
    "reports_all_v2": ["/${apiVersion}/${clientId}/reporting/reports", "GET"],
    ...
    "deposits_get_all_for_user": ["/${apiVersion}/${clientId}/users/${userId}/deposit-preauthorizations", "GET"],
    "deposits_get_transactions": ["/${apiVersion}/${clientId}/deposit-preauthorizations/${depositId}/transactions", "GET"],
    ...
    "create_quoted_conversion": ["/${apiVersion}/${clientId}/conversions/quoted-conversion", "POST"],
    "create_client_wallets_quoted_conversion": ["/${apiVersion}/${clientId}/clients/conversions/quoted-conversion", "POST"],
    "create_client_wallets_instant_conversion": ["/${apiVersion}/${clientId}/clients/conversions/instant-conversion", "POST"],
    "get_conversion": ["/${apiVersion}/${clientId}/conversions/${id}", "GET"],
    "create_quote": ["/${apiVersion}/${clientId}/conversions/quote", "POST"],
    "get_quote": ["/${apiVersion}/${clientId}/conversions/quote/${id}", "GET"],

    "virtual_accounts_create": ["/${apiVersion}/${clientId}/wallets/${walletId}/virtual-accounts", "POST"],
    "virtual_accounts_deactivate": ["/${apiVersion}/${clientId}/wallets/${walletId}/virtual-accounts/${virtualAccountId}", "PUT"],
    "virtual_accounts_get": ["/${apiVersion}/${clientId}/wallets/${walletId}/virtual-accounts/${virtualAccountId}", "GET"],
    "virtual_accounts_get_all": ["/${apiVersion}/${clientId}/wallets/${walletId}/virtual-accounts", "GET"],
    "virtual_accounts_get_availabilities": ["/${apiVersion}/${clientId}/virtual-accounts/availability", "GET"],

    "identity_verification_create": ["/${apiVersion}/${clientId}/users/${userId}/identity-verifications", "POST"],
    "identity_verification_get_all": ["/${apiVersion}/${clientId}/users/${userId}/identity-verifications", "GET"],
    "identity_verification_get": ["/${apiVersion}/${clientId}/identity-verifications/${id}", "GET"],

    "recipients_create": ["/${apiVersion}/${clientId}/users/${userId}/recipients", "POST"],
    "recipients_get": ["/${apiVersion}/${clientId}/recipients/${recipientId}", "GET"],
    "recipients_get_all": ["/${apiVersion}/${clientId}/users/${userId}/recipients", "GET"],
    "recipients_get_schema": ["/${apiVersion}/${clientId}/recipients/schema?payoutMethodType=${payoutMethodType}&recipientType=${recipientType}&currency=${currency}&country=${country}", "GET"],
    "recipients_get_payout_methods": ["/${apiVersion}/${clientId}/recipients/payout-methods?country=${country}&currency=${currency}", "GET"],
