module.exports = {
    ...
    "list_card_fingerprint_transactions": ["/${apiVersion}/${clientId}/cards/fingerprints/${fingerprint}/transactions", "GET"],
    "list_card_fingerprint_users": ["/${apiVersion}/${clientId}/cards/fingerprints/${fingerprint}/users", "GET"],
    ...
    "payins_card-web_details": [`/$\{apiVersion}/$\{clientId}/payins/card/web/\${id}/extended`, "GET"],
