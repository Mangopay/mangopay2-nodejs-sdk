module.exports = {
    ...
    "get_conversion_rate": ["/${apiVersion}/${clientId}/conversion/rate/${debitedCurrency}/${creditedCurrency}", "GET"],
    "create_instant_conversion": ["/${apiVersion}/${clientId}/instant-conversion", "POST"],
    "get_instant_conversion": ["/${apiVersion}/${clientId}/instant-conversion/${id}", "GET"]
};
