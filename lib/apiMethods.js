module.exports = {
  ...
  "users_getemoney" : [ "/${apiVersion}/${clientId}/users/${id}/emoney", "GET" ],
  ...
  "ubo_declaration_create" : ["/${apiVersion}/${clientId}/users/legal/${userId}/ubodeclarations", "POST"],
  "ubo_declaration_update" : ["/${apiVersion}/${clientId}/ubodeclarations/${declarationId}", "PUT"],
  "ubo_declaration_get" : ["/${apiVersion}/${clientId}/ubodeclarations/${declarationId}", "GET"],
