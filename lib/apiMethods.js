module.exports = {
    ...
    "identity_verification_checks_get": ["/${apiVersion}/${clientId}/identity-verifications/${id}/checks", "GET"],
    ...
    "recipients_get_schema": ["/${apiVersion}/${clientId}/recipients/schema?payoutMethodType=${payoutMethodType}&recipientType=${recipientType}&currency=${currency}", "GET"],
