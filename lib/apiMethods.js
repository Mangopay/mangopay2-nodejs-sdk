module.exports = {
    ...
    "payins_mbway-direct_create": ["/${apiVersion}/${clientId}/payins/payment-methods/mbway", "POST"],
    "payins_paypal-direct_create": ["/${apiVersion}/${clientId}/payins/payment-methods/paypal", "POST"],
