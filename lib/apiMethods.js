module.exports = {
    ...
    "payins_paypal-web_create_v2": ["/${apiVersion}/${clientId}/payins/payment-methods/paypal", "POST"],
    ...
    "payins_googlepay-direct_create_v2": ["/${apiVersion}/${clientId}/payins/payment-methods/googlepay", "POST"],
    "payins_recurring_registration": ["/${apiVersion}/${clientId}/recurringpayinregistrations", "POST"],
    ...
    "payouts_check_eligibility": ["/${apiVersion}/${clientId}/payouts/reachability", "POST"],
    ...
    "countries_get_one": ["/${apiVersion}/countries/${countryCode}/authorizations", "GET"],
    ...
    "deposits_cancel": ["/${apiVersion}/${clientId}/deposit-preauthorizations/${depositId}", "PUT"],

    "get_conversion_rate": ["/${apiVersion}/${clientId}/conversions/rate/${debitedCurrency}/${creditedCurrency}", "GET"],
    "create_instant_conversion": ["/${apiVersion}/${clientId}/conversions/instant-conversion", "POST"],
    "get_instant_conversion": ["/${apiVersion}/${clientId}/conversions/${id}", "GET"]
};
