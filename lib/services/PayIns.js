...
const PayInPaymentDetailsOpenBaking = require("../models/PayInPaymentDetailsOpenBanking");
...
var PayIns = Service.extend({
    ...
    getPaymentKey: function(payIn) {
        ...
        if (payIn.PaymentDetails instanceof PayInPaymentDetailsOpenBaking) return 'paybybank';
