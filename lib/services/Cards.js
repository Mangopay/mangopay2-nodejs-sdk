...
var Cards = Service.extend({
    ...
    listCardFingerprintTransactions: function (fingerprint, callback, options) {
        if (options && !options.hasOwnProperty('parameters'))
            Object.assign(options, {parameters: {...options}});
        options = this._api._getOptions(callback, options, {
            path: {
        ...
        return this._api.method('list_card_fingerprint_transactions', callback, options);
    },

    listCardFingerprintUsers: function (fingerprint, callback, options) {
        options = this._api._getOptions(callback, options, {
            path: {
                fingerprint: fingerprint
            },
        ...
        return this._api.method('list_card_fingerprint_users', callback, options);
    }
});
